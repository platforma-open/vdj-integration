...
import { platforma } from "@platforma-open/milaboratories.vdj-integration.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type VdjIntegrationBlockContract = BlockContract;
export type VdjIntegrationBlockOutputs  = BlockOutputs;
export type VdjIntegrationBlockData     = BlockData;
export const VdjIntegrationBlockPointer = BlockPointer;
